...
exports.showAlertSuccess = exports.showAlertError = void 0;

var createAltertContainer = function createAltertContainer(message) {
  ...
  alertContainer.innerHTML = "<div class=\"alert ".concat(type === "warning" ? "alert-warning" : "alert-success", " alert-dismissible fade show\" role=\"alert\">\n  <strong> Error Message:</strong> \n  <br/>").concat(message, ".\n    <button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"alert\" aria-label=\"Close\"></button>\n\n  </div>");
  return alertContainer;
};

var handleValidateionError = function handleValidateionError(error) {
  var errors = Object.values(error.error.errors).map(function (el) {
    return el.message;
  });
  var alertContainer = document.createElement("div");
  alertContainer.classList.add("bs-alert-container");
  var valErrors = errors.map(function (e) {
...
var showAlertError = function showAlertError(error) {
  var message = error.message;
  console.log(error.error != "undefined"); // check if error.error is undefined
  ...
  var formContainer = document.querySelector(".container");
  formContainer.insertBefore(createAltertContainer(message), formContainer.firstChild);
};

exports.showAlertError = showAlertError;

var showAlertSuccess = function showAlertSuccess(message) {
  var formContainer = document.querySelector(".container");
  formContainer.insertBefore(createAltertContainer(message, "success"), formContainer.firstChild);
};

exports.showAlertSuccess = showAlertSuccess;
},{}],"AuthRequest.js":[function(require,module,exports) {
"use strict";
...
function _ref() {
  _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(url, formValues) {
    var response;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            (0, _alert.showAlertSuccess)("Login Sucessfully");
            setTimeout(function () {
          ...
          case 8:
            ...
            if (_context.t0.response) {
              console.log(_context.t0 + "0");
              (0, _alert.showAlertError)(_context.t0.response.data);
            } else if (_context.t0.request) {
              console.log(_context.t0 + "1");
              (0, _alert.showAlertError)(_context.t0);
            } else {
              console.log(_context.t0 + "2");
              (0, _alert.showAlertError)(_context.t0);
            }
...
},{"./alert":"alert.js"}],"AuthHandlers.js":[function(require,module,exports) {
"use strict";
...
var _AuthRequest = _interopRequireDefault(require("./AuthRequest"));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            formValues.name = document.querySelector(".formSignup input[name='name']").value;
            formValues.email = document.querySelector(".formSignup input[name='email']").value;
...
var signInHandler = /*#__PURE__*/function () {
  ...
  return function signInHandler(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

exports.signInHandler = signInHandler;
},{"./AuthRequest":"AuthRequest.js"}],"index.js":[function(require,module,exports) {
"use strict";
